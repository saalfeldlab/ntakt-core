...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("ntakt-core")
                url.set("https://github.com/saalfeldlab/ntakt-core")
                ...
                scm {
                    connection.set("scm:git:git://github.com/saalfeldlab/ntakt-core")
                    developerConnection.set("scm:git:git@github.com:saalfeldlab/ntakt-core")
                    tag.set("HEAD")
                    url.set("https://github.com/saalfeldlab/ntakt-core")
                }
                ciManagement {
                    system.set("Travis CI")
                    url.set("https://travis-ci.com/saalfeldlab/ntakt-core")
                }
                repositories {
